                ...
                for(int ch = 1; ch <= 22; ch++){
                    ...
                    for(int i = start; i<= end;i++){
                        ...
                        for(int kkk=0;kkk<cnvns[i].length;kkk++){
                            boxNL.add(cnvns[i][kkk]);
                            boxNY.add(Math.pow(2,cnvns[i][kkk]+1));
                        }
                        for(int mmm=0;mmm<cnvts[i].length;mmm++){
                            boxTL.add(cnvts[i][mmm]);
                            boxTY.add(Math.pow(2,cnvts[i][mmm]+1));
                        }
